...
## [Code of Conduct](https://github.com/gregberge/smooth-doc/blob/master/CODE_OF_CONDUCT.md)

We expect project participants to adhere to our Code of Conduct. Please read [the full text](https://github.com/gregberge/smooth-doc/blob/master/CODE_OF_CONDUCT.md) so that you can understand what actions will and will not be tolerated.
...
1.  Fork the repo and create your branch from `master`. A guide on how to fork a repository: https://help.github.com/articles/fork-a-repo/
    ...
    ```sh-session
    $ git clone https://github.com/<your_username>/smooth-doc
    $ cd smooth-doc
