module.exports = function config({
  ...
  const plugins = [
    ...
    {
      resolve: require.resolve('./src/plugins/gatsby-remark-autolink-headers'),
    },
    {
  ...
  if (enableDocSearch) {
    plugins.push({
      ...
      options: {
        apiKey: algoliaDocSearch.apiKey,
        indexName: algoliaDocSearch.indexName,
        inputSelector: algoliaDocSearch.inputSelector,
        debug: algoliaDocSearch.debug,
      },
    })
  }
  return {
