...
Bad news: color is complicated and we've yet to find a tool that does a good job generating these sorts of color palettes. I picked all Tailwind colors which they actually made by hand. Sorry!
