...
Smooth DOC is a ready to use [Gatsby](https://gatsbyjs.com/) theme to create a documentation website like this one. Creating a pro-quality website like this one takes weeks. Smooth DOC saves you lot of time and let you focus on the content.

Smooth DOC is not open source, it is a commercial product. It means you have to [buy a license](https://gumroad.com/l/smooth-doc) to use it.
...
Smooth DOC options are filled directly in `gatsby-config.js`. To make it yours, change the name and the description:
